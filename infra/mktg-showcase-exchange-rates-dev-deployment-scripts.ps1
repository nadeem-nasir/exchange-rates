...
az deployment group create --resource-group "rg-mktg-crmio-dev-01" --template-file "mktg-showcase-exchange-rates-main.bicep" --parameters "mktg-showcase-exchange-rates-main-dev.bicepparam" 
